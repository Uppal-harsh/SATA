...
export function CommandPalette({ isOpen, onClose, onSelectEvent, audio }) {
  ...
  const searchItems = [
    ...
    { title: "Anushka — Tech Lead (CSE 4)", category: "Leadership", type: "nav", href: "#people", icon: User },
    { title: "Bhavika Bansal — Design Lead", category: "Leadership", type: "nav", href: "#people", icon: User },
    { title: "Gyanesh Nayak — AI Lead", category: "Leadership", type: "nav", href: "#people", icon: User },
    { title: "Hardik Wadhwa — Hardware Lead", category: "Leadership", type: "nav", href: "#people", icon: User },
    { title: "Harsh Chahal — Operations Lead", category: "Leadership", type: "nav", href: "#people", icon: User },
